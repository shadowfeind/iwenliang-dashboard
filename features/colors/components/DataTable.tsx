    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="lowercase">
          {row.getValue("hexValue")}{" "}
          <span
            className="h-3 w-6 inline-block"
            style={{ backgroundColor: row.getValue("hexValue") }}
          ></span>
        </div>
      ),
    },
