...
export function DataTable({ data }: { data: BeadType[] }) {
  ...
  const [beadSizeId, setBeadSizeId] = React.useState<string | null>(null);
  ...
  const columns: ColumnDef<BeadType>[] = [
    {
      accessorKey: "name",
      header: ({ column }) => {
        return (
