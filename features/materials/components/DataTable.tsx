...
import CreateOrUpdateMaterial from "./CreateOrUpdateMaterial";
import { deleteMaterial } from "@/features/materials/material.action";

export function DataTable({ data }: { data: MaterialType[] }) {
