...
import { BLOG_ADD_ROUTE, BLOG_ROUTE } from "@/config/constant/routes";
import { deleteBlog } from "../blog.action";

export function DataTable({ data }: { data: BlogTYpe[] }) {
  ...
  const columns: ColumnDef<BlogTYpe>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="lowercase">
          {row.getValue("content")?.toString()?.slice(0, 30)}...
        </div>
      ),
    },
    {
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <>
                ...
                <DropdownMenuItem
                  onClick={() =>
                    router.push(`${BLOG_ROUTE}/${row.original.slug}/edit`)
                  }
                >
                  Edit
                </DropdownMenuItem>
  ...
  return (
    <div className="w-full">
      <div className="flex flex-col items-start gap-2 md:flex-row md:justify-between md:items-center md:gap-0 pb-4">
        ...
        />
        <div>
          <Button className="mr-2" onClick={() => router.push(BLOG_ADD_ROUTE)}>
            Add New Blog
          </Button>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
