...
export function DataTable({
  ...
  const columns: ColumnDef<ShippingType>[] = [
    {
      accessorKey: "orderId",
      header: ({ column }) => {
        return (
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="lowercase">{row.getValue("dispatchedTo")}</div>
      ),
    },
    {
      ...
      cell: ({ row }) => (
        <div className="lowercase">{row.getValue("trackingNo")}</div>
      ),
    },
    {
