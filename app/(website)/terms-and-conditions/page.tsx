              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    ...
                    www.iwenleng.com uses and protects the data you provide to
                    us when you visit and use our website.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="data-collection">
                      ...
                      <AccordionContent>
                        <p>
                          When you visit the website, we may collect the
                          following data:
                        </p>
                    ...
                    <AccordionItem value="data-usage">
                      ...
                      <AccordionContent>
                        ...
                        <ul className="list-disc pl-5 mt-2 space-y-1">
                          ...
                          <li>
                            To send you promotional emails containing
                    ...
                    <AccordionItem value="data-security">
                      ...
                      <AccordionContent>
                        <p>
                          Iwenliang is committed to securing your data and
                          keeping it confidential. We have done all in our power
                          to prevent data theft, unauthorized access, and
                          disclosure by implementing the latest technologies and
                          software, which help us safeguard all the information
                          we collect online.
                        </p>
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="cookie-policy">
                      ...
                      <AccordionContent>
                        <p>
                          Once you agree to allow our website to use cookies,
                          you also agree to use the data it collects regarding
                          your online behaviour (analyse web traffic, web pages
                          you spend the most time on, and websites you visit).
                        </p>
                        <p className="mt-2">
                        ...
                        <p className="mt-2">
                          Please note that cookies don't allow us to gain
                          control of your computer in any way. They are strictly
                          used to monitor which pages you find useful and which
                          you do not so that we can provide a better experience
                          for you.
                        </p>
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="external-links">
                      ...
                      <AccordionContent>
                        <p>
                          Our website contains links that lead to other
                          websites. If you click on these links, Iwenliang is
                          not held responsible for your data and privacy
                          protection. Visiting those websites is not governed by
                          this privacy policy agreement. Make sure to read the
                          privacy policy documentation of the website you go to
                          from our website.
                        </p>
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="data-restriction">
                      ...
                      <AccordionContent>
                        ...
                        <ul className="list-disc pl-5 mt-2 space-y-1">
                          <li>
                            When filling forms on the website, check if there is
                            a box which you can leave unchecked if you don't
